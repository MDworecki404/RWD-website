...
var _hamburgerMenu = require("./src/scripts/hamburger-menu");
var _hamburgerMenuDefault = parcelHelpers.interopDefault(_hamburgerMenu);
var _scrollTrigger = require("./src/scripts/scrollTrigger");
var _scrollTriggerDefault = parcelHelpers.interopDefault(_scrollTrigger);

},{"./src/scripts/hamburger-menu":"bb6GC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./src/scripts/scrollTrigger":"1BnqA"}],"bb6GC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const hamburgerMenuOpen = ()=>{
    if (hamburgerState === 1) {
        ...
        (0, _gsap.TweenMax).to(bar1, 0.3, {
            y: 0,
            transform: "rotate(0)"
        });
        (0, _gsap.TweenMax).to(bar3, 0.3, {
            y: 0,
            transform: "rotate(0)"
        });
        (0, _gsap.TweenMax).to(menu, 0.3, {
            x: 0
        });
        ...
        (0, _gsap.TweenMax).to(bar11, 0.3, {
            y: "0.9rem",
            transform: "rotate(45deg)"
        });
        (0, _gsap.TweenMax).to(bar31, 0.3, {
            y: "-0.9rem",
            transform: "rotate(-45deg)"
        });
        (0, _gsap.TweenMax).to(menu, 0.3, {
...
exports.default = hamburgerMenuOpen;
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1BnqA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gsap = require("gsap");
        ...
        self.revert = function(revert, temp) {
            ...
            if (r !== self.isReverted) {
                ...
                if (pin) {
                    ...
                    else (!pinReparent || !self.isActive) && _swapPinIn(pin, spacer, _getComputedStyle(pin), spacerState);
                }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequire310e")
