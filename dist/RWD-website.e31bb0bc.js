...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"src/scripts/hamburger-menu.js":[function(require,module,exports) {
"use strict";
...
var hamburgerMenuOpen = function hamburgerMenuOpen() {
  if (hamburgerState === 1) {
    var bar1 = document.querySelector(".bar1");
    var bar2 = document.querySelector(".bar2");
    var bar3 = document.querySelector(".bar3");
    var hamList = document.querySelectorAll(".hamList");
    _gsap.TweenMax.to(hamList, 0, {
      x: -500,
      delay: 0,
      stagger: 0
    });
    _gsap.TweenMax.to(bar2, 0.3, {
      x: 0
    });
    _gsap.TweenMax.to(bar1, 0.3, {
      y: 0,
      transform: "rotate(0)"
    });
    _gsap.TweenMax.to(bar3, 0.3, {
      y: 0,
      transform: "rotate(0)"
    });
    _gsap.TweenMax.to(menu, 0.3, {
      x: 0
    });
    hamburgerState = hamburgerState - 1;
    console.log(hamburgerState);
  } else if (hamburgerState === 0) {
    var _bar = document.querySelector(".bar1");
    var _bar2 = document.querySelector(".bar2");
    var _bar3 = document.querySelector(".bar3");
    var _hamList = document.querySelectorAll(".hamList");
    _gsap.TweenMax.to(_hamList, 0.3, {
      x: 0,
      delay: 0.3,
      stagger: 0.1
    });
    _gsap.TweenMax.to(_bar2, 0.3, {
      x: -150
    });
    _gsap.TweenMax.to(_bar, 0.3, {
      y: "0.9rem",
      transform: "rotate(45deg)"
    });
    _gsap.TweenMax.to(_bar3, 0.3, {
      y: "-0.9rem",
      transform: "rotate(-45deg)"
    });
    _gsap.TweenMax.to(menu, 0.3, {
...
var _default = hamburgerMenuOpen;
...
},{"./Observer.js":"node_modules/gsap/Observer.js"}],"src/scripts/scrollTrigger.js":[function(require,module,exports) {
"use strict";
...
var section2 = document.querySelector(".articles");
var scroll = function scroll() {
  _gsap.gsap.fromTo(section2.children, {
    x: "+=100",
    opacity: 0
  }, {
    x: 0,
...
var _default = scroll;
exports.default = _default;
},{"gsap":"node_modules/gsap/index.js","gsap/ScrollTrigger":"node_modules/gsap/ScrollTrigger.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _hamburgerMenu = _interopRequireDefault(require("./src/scripts/hamburger-menu"));
var _scrollTrigger = _interopRequireDefault(require("./src/scripts/scrollTrigger"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./src/scripts/hamburger-menu":"src/scripts/hamburger-menu.js","./src/scripts/scrollTrigger":"src/scripts/scrollTrigger.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/RWD-website.e31bb0bc.js.map